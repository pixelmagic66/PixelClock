...
// deze versie is de werkende in de wordklok op 16-9-2020
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.print("Adapted from BITLAIR Wordclock, v");
  Serial.println(version);
  Serial.println("PixelClock 2020 https://github.com/pixelmagic66/PixelClock");
  Serial.print("ESP ID: ");
